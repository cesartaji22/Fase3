...
public partial class transferencias_terceros : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        String[] lista2 = servicio.mostrar_cuentas_asociadas(id);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (saldo_cuenta_origen > Double.Parse(TextBox1.Text))
        {
            ...
            servicio.historial_cliente(cuentaa, "2017-05-10", "Retiro de la cuenta No. " + DropDownList1.SelectedItem.ToString() + ", transaccion a tercero",
                0, Double.Parse(TextBox1.Text), saldoa);
            //// del deposito

            int cuentab = servicio.retornar_id_cuenta(DropDownList2.SelectedItem.ToString());

            servicio.historial_cliente(cuentab, "2017-05-10", "Deposito a la cuenta No. " + DropDownList2.SelectedItem.ToString() + ", Deposito de tercero",
