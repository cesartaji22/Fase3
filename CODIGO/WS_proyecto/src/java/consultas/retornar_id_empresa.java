 ...
 * @author TAJI
 */
public class retornar_id_empresa {
    ...
    public int devolver_id_empresa(String patente) {
    int identificador =0;    
        consulta = "select id_cliente_empresa from cliente_empresa where patente='"+patente+"';";
